...
export default function LandingPage() {
  ...
  const adminLink = user?.role === 'admin' ? '/admin/dashboard' : '/login';
    ...
    <div className="min-h-screen bg-white text-slate-900 dark:bg-black dark:text-white">
      ...
      <main className="space-y-24">
        ...
        <section className="bg-slate-50 dark:bg-slate-900">
          <div className="page-container py-20">
            <div className="mx-auto mb-12 max-w-2xl text-center">
              <p className="text-sm uppercase tracking-[0.32em] text-[#f4b400]">Our Staffing Services</p>
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {services.map((service) => (
                <div key={service.title} className="rounded-[1.75rem] border border-slate-200 bg-white p-8 shadow-soft dark:border-slate-800 dark:bg-slate-950">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-orange-50 text-[#f4b400]">
                    <Briefcase size={24} />
                  </div>
        ...
        <section className="page-container">
          <div className="mx-auto mb-12 max-w-2xl text-center">
            <p className="text-sm uppercase tracking-[0.32em] text-[#f4b400]">Why Super Deals Staffing</p>
        ...
        <section className="page-container grid gap-8 lg:grid-cols-2">
          <div className="rounded-[1.75rem] border border-slate-200 bg-slate-950 p-10 text-white shadow-soft">
            <p className="text-sm uppercase tracking-[0.32em] text-[#f4b400]">Need Skilled Talent Fast?</p>
            ...
            <Link
              to={adminLink}
              className="mt-8 inline-flex items-center gap-2 rounded-2xl btn-primary px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-orange-500/20 transition hover:bg-orange-600"
            >
              Request Talent
            </Link>
          </div>
          ...
          <div className="rounded-[1.75rem] border border-slate-200 bg-white p-10 shadow-soft">
            <p className="text-sm uppercase tracking-[0.32em] text-[#f4b400]">Looking for the Right Opportunity?</p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Link to="/seeker/opportunities" className="inline-flex items-center justify-center rounded-2xl btn-primary px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-orange-500/20 transition hover:bg-orange-600">
                Browse Jobs
              </Link>
            </div>
          </div>
        ...
        <section className="bg-slate-950 text-white">
          <div className="page-container py-20">
            <div className="mx-auto mb-12 max-w-2xl text-center">
              <p className="text-sm uppercase tracking-[0.32em] text-[#f4b400]">Our Impact</p>
        ...
        <section className="page-container">
          <div className="mx-auto mb-12 max-w-2xl text-center">
            <p className="text-sm uppercase tracking-[0.32em] text-[#f4b400]">What Clients Say</p>
        ...
        <section className="bg-orange-500 text-white">
          <div className="page-container rounded-[2rem] border border-white/10 bg-orange-500/95 p-14 shadow-soft">
            <div className="grid gap-8 lg:grid-cols-[1.3fr_0.7fr] items-center">
              <div>
                <p className="text-sm uppercase tracking-[0.32em] text-[#f4b400]">Ready to Build Your Team?</p>
              ...
              <Link className="inline-flex items-center justify-center rounded-2xl bg-slate-950 px-8 py-4 text-sm font-semibold text-white shadow-xl shadow-slate-950/25 transition hover:bg-slate-800" to={adminLink}>
                Get Started Today
              </Link>
            </div>
          </div>
